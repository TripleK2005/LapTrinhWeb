...
namespace Lab09.Controllers
{
    ...
    {
        private readonly Lab09Dbfirst1Context _context;

        public CtHoaDonsController(Lab09Dbfirst1Context context)
        {
            _context = context;
        }
        ...
        {
            var lab09Dbfirst1Context = _context.CtHoaDons.Include(c => c.HoaDon).Include(c => c.SanPham);
            return View(await lab09Dbfirst1Context.ToListAsync());
        }
